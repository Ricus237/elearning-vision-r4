...
const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    router.push("/dashboard"); // Redirect to dashboard after login for testing
  };
        ...
        <div className="max-w-md mx-auto bg-white rounded-3xl shadow-card p-8 sm:p-12 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link href="/sign-up" className="font-semibold text-purple-600 hover:text-purple-500 transition-colors">
                Sign up
              </Link>
            </p>
          </form>
