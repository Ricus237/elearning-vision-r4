...
const MyCoursesClient = ({ initialCourses }: MyCoursesClientProps) => {
          ...
          {filteredCourses.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {filteredCourses.map((course) => (
                <div key={course._id} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1 p-6 flex flex-col justify-between">
                      ...
                      <div>
                        ...
                        <div className="w-full bg-gray-100 rounded-full h-2">
                          <div
                            className="h-2 rounded-full transition-all bg-purple-600"
                            style={{ width: `0%` }}
                          ></div>
                        </div>
