      ...
      <div className="container px-6 mx-auto">
        ...
        >
          ...
          <p className="text-xl text-slate-500 mt-6 max-w-2xl mx-auto italic">
            Equipping the next generation of spiritual and global leaders.
          </p>
        </motion.div>
               ...
               <div className="grid md:grid-cols-2 gap-12 mt-16">
                  ...
                  <div className="space-y-6">
                     ...
                     <ul className="space-y-4">
                        {[
                           "40-minute pre-recorded lessons",
                  ...
                  <div className="space-y-6">
                     <div className="flex items-center gap-3 text-slate-900">
                        ...
                        <h3 className="text-2xl font-black font-serif">Overview</h3>
                     </div>
                     <ul className="space-y-4">
                        {[
        ...
        >
          <p className="text-slate-400 font-bold uppercase tracking-[0.2em] text-sm">
            Academic Excellence &middot; Spiritual Fire &middot; Global Impact
          </p>
        </motion.div>
      </div>
    </main>
