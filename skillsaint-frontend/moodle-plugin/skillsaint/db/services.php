...
$functions = array(
    ...
    // ---- Plan Upgrade System ----
    'local_skillsaint_request_plan_upgrade' => array(
        'classname'   => 'local_skillsaint_external',
        'methodname'  => 'request_plan_upgrade',
        'classpath'   => 'local/skillsaint/externallib.php',
        'description' => 'Student requests a plan upgrade (requires admin approval)',
        'type'        => 'write',
        'ajax'        => true,
    ),
    'local_skillsaint_get_pending_upgrades' => array(
        'classname'   => 'local_skillsaint_external',
        'methodname'  => 'get_pending_upgrades',
        'classpath'   => 'local/skillsaint/externallib.php',
        'description' => 'Admin: get all plan upgrade requests',
        'type'        => 'read',
        'ajax'        => true,
        'capabilities'=> 'moodle/site:config',
    ),
    'local_skillsaint_approve_upgrade' => array(
        'classname'   => 'local_skillsaint_external',
        'methodname'  => 'approve_upgrade',
        'classpath'   => 'local/skillsaint/externallib.php',
    ...
    'local_skillsaint_reject_upgrade' => array(
        'classname'   => 'local_skillsaint_external',
        'methodname'  => 'reject_upgrade',
        'classpath'   => 'local/skillsaint/externallib.php',
    ...
    'local_skillsaint_get_my_upgrade_status' => array(
        'classname'   => 'local_skillsaint_external',
        'methodname'  => 'get_my_upgrade_status',
        'classpath'   => 'local/skillsaint/externallib.php',
        'description' => 'Student: get own upgrade request status',
        'type'        => 'read',
        'ajax'        => true,
    ),
...
$services = array(
    'Skillsaint Core Services' => array(
        'functions' => array(
            ...
            'local_skillsaint_request_plan_upgrade',
            'local_skillsaint_get_pending_upgrades',
